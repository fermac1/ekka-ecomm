          ...
          @if(session('cart'))
           ...
           <div class="ec-cart-top">
               ...
               <ul class="eccart-pro-items">
                   ...
                   <li>
                       <a href="{{ url('single-product') }}" class="sidekka_pro_img"><img
                               src="{{ asset('frontend/images/product/'. $details['image']) }}" alt="product"></a>
                       <div class="ec-pro-content">
                           <a href="{{ url('single-product') }}" class="cart_pro_title"> {{ $details['product_name'] }} </a>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                ...
                                {{-- <div class="qty-slide">
                                    <img class="img-responsive" src="{{ asset('frontend/images/product/'. $product->image) }}" alt="">
                                </div> --}}

                                @foreach ($product_attr as $item)
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{ asset('frontend/images/product/'. $item->images) }}" alt="">
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="{{url('single-product/'. $product->slug)}}"> {{$product->product_name}} </a>
                                </h5>
                                        ...
                                        <div class="ec-pro-variation-content">
                                            <ul class="ec-opt-size">
                                                ...
                                                <li class="{{ $loop->first ? 'active' : '' }}"><a href="#" class="ec-opt-sz"
                                                        data-tooltip="Small">{{$item->size}}</a></li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </div>
...
<div class="ec-nav-toolbar">
    <div class="container">
        <div class="ec-nav-panel">
            ...
            <div class="ec-nav-panel-icons">
                <a href="{{ url('/') }}" class="ec-header-btn"><img src="{{ asset('frontend/images/icons/home.svg') }}"
