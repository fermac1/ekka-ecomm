                ...
                <div class="col d-lg-none ">
                    <div class="ec-header-bottons">
                        ...
                        <a href="javascript:void(0)" class="ec-header-btn ec-sidebar-toggle">
                            <img src="{{ asset('frontend/images/icons/category-icon.svg') }}" class="svg_img header_svg" alt="icon" />
                        </a>
                        <!-- Header menu Start -->
                    ...
                    <div class="ec-main-menu">
                        ...
                        <ul>
                            ...
                            <li class="dropdown scroll-to"><a href="javascript:void(0)"><img
                                src="{{ asset('frontend/images/icons/scroll.svg') }}" class="svg_img header_svg scroll" alt="" /></a>
                                <ul class="sub-menu">
...
<!-- Header End  -->
                 ...
                 <ul class="eccart-pro-items">
                     ...
                     <li>
                         <a href="{{url('single-product/'.$details['slug'])}}" class="sidekka_pro_img"><img
                                 src="{{ asset('frontend/images/product/') }}" alt="product"></a>
                     ...
                     <div class="ec-sidebar-wrap">
                         ...
                         <div class="ec-sidebar-block">
                             ...
                             <div class="ec-sb-block-content">
                                <ul>
                                    <li>
                                        <div class="ec-sidebar-block-item"><img src="{{ asset('frontend/images/icons/dress-8.svg') }}" class="svg_img" alt="drink" /> {{ $cat->category_name }} </div>
                                        <ul style="display: block;">

                                            @foreach ($cat->subcategory as $subcat)
                                            <li>
                                                <div class="ec-sidebar-sub-item"><a href="{{ url('category/'.$cat->slug) }}">{{ $subcat->name }} <span title="Available Stock">{{ count($subcat->product) }}</span></a>
                                                </div>
                                            </li>
                                            @endforeach
    ...
    @foreach ($modal_product as $prod) 
    @php
        $product_attr = DB::table('product_attributes')->where('prod_id', $prod->id)->get();
        $product_attr_first = DB::table('product_attributes')->where('prod_id', $prod->id)->first();
    @endphp    
    <!-- Modal -->
    <div class="modal fade" id="ec_quickview_modal_{{$prod->id}}" tabindex="-1" role="dialog">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-7 col-sm-12 col-xs-12">
                          <div class="quickview-pro-content">
                              <h5 class="ec-quick-title"><a href="product-left-sidebar.html"> {{$prod->product_name}} </a>
                              </h5>
                              ...
                              <div class="ec-quickview-desc"> {{$prod->description}} </div>
                              <div class="ec-quickview-price">

                                {{-- @foreach ($product_attr as $product_item) --}}
                              ...
                              <div class="ec-quickview-qty">
                                ...
                                <div class="ec-quickview-cart ">
                                    <button class="btn btn-primary add-to-cart"><img src="{{ asset('frontend/images/icons/cart.svg') }}"
                                            class="svg_img pro_svg" alt="" /> <a href="{{ route('add.to.cart', $prod->id) }}" style="color: inherit" > Add To Cart </a></button>
                                </div>
                              </div>
                          </div>
                      </div>
  ...
  <!-- Modal end -->
    ...
    <div id="ec-popnews-box">
        ...
        <div class="row">
            <div class="col-md-6 disp-no-767">
                <img src="{{ asset('frontend/images/banner/newsletter.png') }}" alt="newsletter">
            </div>
            <div class="col-md-6">
            ...
            <div class="ec-nav-panel">
                <div class="ec-nav-panel-icons">
                    <a href="#ec-mobile-menu" class="navbar-toggler-btn ec-header-btn ec-side-toggle"><img
                            src="{{ asset('frontend/images/icons/menu.svg') }}" class="svg_img header_svg" alt="icon" /></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="#ec-side-cart" class="toggle-cart ec-header-btn ec-side-toggle"><img
                            src="{{ asset('frontend/images/icons/cart.svg') }}" class="svg_img header_svg" alt="icon" /><span
    ...
    <div class="ec-cart-float">
        <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
            <div class="header-icon"><img src="{{ asset('frontend/images/icons/cart.svg') }}" class="svg_img header_svg" alt="cart" />
            </div>
            <span class="ec-cart-count cart-count-lable">{{ count((array) session('cart')) }}</span>
        </a>
    </div>
