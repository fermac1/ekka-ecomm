                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="tab-pro-for-all">
                          <div class="row">
                                ...
                                @php
                                    $product_attr = DB::table('product_attributes')->where('prod_id', $top_product->id)->get();
                                    $product_attr_first = DB::table('product_attributes')->where('prod_id', $top_product->id)->first();
                                @endphp

                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content cart-row" data-animation="fadeIn">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="{{ url('single-product/'.$top_product->slug) }}" class="image">
                                                ...
                                                <a href="#" class="quickview" data-link-action="quickview"
                                                    ...
                                                    data-bs-target="#ec_quickview_modal_{{$top_product->id}}"><img
                                                ...
                                                <div class="ec-pro-actions">
                                                    ...
                                                    <button title="Add To Cart" class="add-to-cart"><a href="{{ route('add.to.cart', $top_product->id) }}"> <img
                                                        src="{{ asset('frontend/images/icons/cart.svg') }}"  class="svg_img pro_svg"
                                                        alt="" /> Add To Cart </a></button>
                                                    
                                                    <a href="{{ url('add-to-wishlist/'.$top_product->id) }}" class="ec-btn-group wishlist" title="Wishlist"><img
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <h5 class="ec-pro-title"><a href="{{ url('single-product/'.$top_product->slug) }}"> {{ $top_product->product_name }} </a></h5>
                                            ...
                                            <span class="ec-price">
                                                ...
                                                <span class="old-price">${{ number_format(($product_attr_first->regular_price), 2) }}</span>
                                                @endif
                                                <span class="new-price">${{ number_format(($product_attr_first->sale_price), 2) }}</span>
                                            </span>
                                            <div class="ec-pro-option">
                                                ...
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        @foreach ($top_product->productAttribute as $attrItem)
                                                            
                                                        <li class="{{ $loop->first ? 'active' : '' }}"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product/'. $attrItem->images) }}"
                                                                data-src-hover="{{ asset('frontend/images/product/'.$attrItem->images) }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:{{$attrItem->color}};"></span></a></li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                                @endif
                                                ...
                                                <div class="ec-pro-size">
                                                    ...
                                                    <ul class="ec-opt-size">
                                                        ...
                                                        @if ($attrItem->regular_price)
                                                        <li class="{{ $loop->first ? 'active' : '' }}"><a href="#" class="ec-opt-sz" 
                                                               data-old="${{  $attrItem->regular_price }}" data-new="${{$attrItem->sale_price}}"
                                                                data-tooltip="">{{$attrItem->size}}</a></li>
                                                           @else 
                                                           <li class="{{ $loop->first ? 'active' : '' }}"><a href="#" class="ec-opt-sz" data-new="${{$attrItem->sale_price}}"
                                                             data-tooltip="">{{$attrItem->size}}</a></li>
                                                        @endif
                                                        @endforeach
                                                    </ul>
                                ...
                                <div class="col-sm-12 shop-all-btn"><a href="{{ url('category_products') }}">Shop All Collection</a></div>
                            </div>
                        </div>
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/images/product-image/10_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/images/product-image/10_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product-image/10_1.jpg') }}"
                                                                data-src-hover="{{ asset('frontend/images/product-image/10_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#41d49c;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product-image/10_2.jpg') }}"
                                                                data-src-hover="{{ asset('frontend/images/product-image/10_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#fc8484;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product-image/10_3.jpg') }}"
                                                                data-src-hover="{{ asset('frontend/images/product-image/10_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#db94f7;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product-image/10_4.jpg') }}"
                                                                data-src-hover="{{ asset('frontend/images/product-image/10_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        ...
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product-image/3_5.jpg') }}"
                                                                data-src-hover="{{ asset('frontend/images/product-image/3_5.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                            ...
                                            <div class="ec-pro-image">
                                                ...
                                                <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                                    data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                                                        src="{{ asset('frontend/images/icons/quickview.svg') }}"  class="svg_img pro_svg" alt="" /></a>
                                                <div class="ec-pro-actions">
                                                    <a href="compare.html" class="ec-btn-group compare" title="Compare"><img
                                                            src="{{ asset('frontend/images/icons/compare.svg') }}"  class="svg_img pro_svg" alt="" /></a>
                                                    <button title="Add To Cart" class="add-to-cart"><img
                                                            src="{{ asset('frontend/images/icons/cart.svg') }}"  class="svg_img pro_svg" alt="" /> Add To
                                                        Cart</button>
                                                    <a class="ec-btn-group wishlist" title="Wishlist"><img
                                                            src="{{ asset('frontend/images/icons/wishlist.svg') }}"  class="svg_img pro_svg" alt="" /></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ec-pro-content">
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/images/product-image/14_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/images/product-image/14_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                                    title="Quick view" data-bs-toggle="modal"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/images/product-image/15_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/images/product-image/15_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/images/product-image/16_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/images/product-image/16_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="new">New</span>
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/images/product-image/17_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/images/product-image/17_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product-image/17_1.jpg') }}"
                                                                data-src-hover="{{ asset('frontend/images/product-image/17_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#8ad2fc;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product-image/17_2.jpg') }}"
                                                                data-src-hover="{{ asset('frontend/images/product-image/17_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#ff8ef6;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product-image/17_3.jpg') }}"
                                                                data-src-hover="{{ asset('frontend/images/product-image/17_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ffbe31;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product-image/17_4.jpg') }}"
                                                                data-src-hover="{{ asset('frontend/images/product-image/17_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <ul class="ec-cat-tab-nav nav">
                        ...
                        <li class="cat-item"><a class="cat-link {{ $loop->first ? 'active' : '' }} {{ Request::path() === $item->name ? 'active' : ''  }}" data-bs-toggle="tab" href="#tab-cat-{{ $item->id }}">
                                <div class="cat-icons"><img class="cat-icon" src="{{ asset('frontend/images/icons/'.$item->icon) }}"
                                        alt="cat-icon"><img class="cat-icon-hover" src="{{ asset('frontend/images/icons/'. $item->icon) }}"
                                        alt="cat-icon"></div>
                                <div class="cat-desc"><span>{{ $item->category_name }}</span><span>
                                    @php
                                        $cate_id = $item->id;
                ...
                <div class="col-lg-9">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade {{ $loop->first ? 'show' : '' }} {{ $loop->first ? 'active' : '' }} {{ Request::path() === $item->name ? 'show' : ''  }} {{ Request::path() === $item->name ? 'active' : ''  }}" id="tab-cat-{{ $item->id }}">
                            <div class="row">
                                {{-- <img src="{{ asset('frontend/images/cat-banner/1.jpg') }}" alt="" /> --}}
                                <img src="{{ asset('frontend/images/category-image/'. $item->image) }}" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="{{ url('category/'.$item->slug) }}" class="btn btn-primary">View All</a>
                            </span>
                        </div>
                        <!-- 1st Category tab end -->
                        @endforeach
            ...
            <div class="row">
                ...
                <div class="ec-fre-section col-lg-6 col-md-6 col-sm-6 margin-b-30" data-animation="slideInRight">
                    ...
                    <div class="ec-fre-products">
                        ...
                        @php
                            $feature_product_attr = DB::table('product_attributes')->where('prod_id', $feature_product->id)->get();
                            $feature_product_attr_first = DB::table('product_attributes')->where('prod_id', $feature_product->id)->first();
                        @endphp 

                        <div class="ec-fs-product cart-row">
                            <div class="ec-fs-pro-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="{{url('single-product/'.$feature_product->slug)}}" class="image"><img class="main-image"
                                                src="{{ asset('frontend/images/product/'.$feature_product_attr_first->images) }}" alt="Product" /></a>
                                        <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                            data-bs-toggle="modal" data-bs-target="#ec_quickview_modal_{{$feature_product->id}}"><img
                                                src="{{ asset('frontend/images/icons/quickview.svg') }}"  class="svg_img pro_svg"
                                                alt="" /></a>
                                    </div>
                                </div>
                                <div class="ec-fs-pro-content col-lg-6 col-md-6 col-sm-6">
                                    <h5 class="ec-fs-pro-title"><a href="{{ url('single-product/'.$feature_product->slug) }}"> {{ $feature_product->product_name}} </a>
                                    </h5>
                                    ...
                                    <div class="ec-fs-price">
                                        @if ($feature_product_attr_first->regular_price)
                                        <span class="old-price">${{ number_format(($feature_product_attr_first->regular_price), 2) }}</span>
                                        @endif
                                        
                                        <span class="new-price">${{ number_format(($feature_product_attr_first->sale_price), 2) }}</span>
                                    </div>

                                    <div class="countdowntimer"><span id="ec-fs-count-1"></span></div>
                                    <div class="ec-fs-pro-desc">{{ $feature_product->description }}
                                    </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        ...
                        <p class="sub-title">Browse The Collection of <a href="catalog-multi-vendor.html">All Brands.</a></p>
                    </div>
                </div>
            </div>
            <div class="row margin-minus-t-15 margin-minus-b-15">
                    ...
                    <div class="ec-vendor-card">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                               <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/1_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/2_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/3_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/4_1.jpg') }}" alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                               <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/5_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/6_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/7_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/8_1.jpg') }}" alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                               <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/9_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/10_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/11_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/12_1.jpg') }}" alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                               <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/13_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/14_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/15_1.jpg') }}" alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('frontend/images/product-image/16_1.jpg') }}" alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center ec-offer-content">
                    ...
                    <span class="ec-offer-img" data-animation="zoomIn"><img src="{{ asset('frontend/images/offer-image/1.png') }}" alt="offer image" /></span>
    ...
    <section class="section ec-new-product section-space-p" id="arrivals">
        <div class="container">
            ...
            <div class="row">
                ...
                @php
                    $new_product_attr = DB::table('product_attributes')->where('prod_id', $new_arrival->id)->get();
                    $new_product_attr_first = DB::table('product_attributes')->where('prod_id', $new_arrival->id)->first();
                @endphp
                <!-- New Product Content -->
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{ asset('frontend/images/product/'. $new_product_attr_first->images) }}"
                                        alt="Product" />
                                    <img class="hover-image" src="{{ asset('frontend/images/product/'. $new_product_attr_first->images) }}"
                                        alt="Product" />
                                </a>
                                @if ($new_product_attr_first->discount)
                                    <span class="percentage">{{$new_product_attr_first->discount}}%</span>
                                @endif
                                
                                @if ($new_arrival->status)
                                <span class="flags">
                                    <span class="sale">{{ $new_arrival->status }}</span>
                                </span>
                                @endif

                                <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                    data-bs-toggle="modal" data-bs-target="#ec_quickview_modal_{{$new_arrival->id}}"><img
                                        src="{{ asset('frontend/images/icons/quickview.svg') }}"  class="svg_img pro_svg" alt="" /></a>
                                <div class="ec-pro-actions">
                                    <a href="compare.html" class="ec-btn-group compare" title="Compare"><img
                                            src="{{ asset('frontend/images/icons/compare.svg') }}"  class="svg_img pro_svg" alt="" /></a>
                                    <button title="Add To Cart" class="add-to-cart"><a href="{{ route('add.to.cart', $new_arrival->id) }}"> <img
                                            src="{{ asset('frontend/images/icons/cart.svg') }}"  class="svg_img pro_svg" alt="" /> Add To
                                        Cart </a></button>
                                    <a href="{{ url('add-to-wishlist/'.$new_arrival->id) }}" class="ec-btn-group wishlist" title="Wishlist"><img
                                            src="{{ asset('frontend/images/icons/wishlist.svg') }}"  class="svg_img pro_svg" alt="" /></a>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="{{ url('single-product/'.$new_arrival->slug) }}"> {{$new_arrival->product_name}} </a></h5>
                            <div class="ec-pro-rating">
                                <i class="ecicon eci-star fill"></i>
                                <i class="ecicon eci-star fill"></i>
                                <i class="ecicon eci-star fill"></i>
                            ...
                            <span class="ec-price">
                                @if ($new_product_attr_first->regular_price)
                                    <span class="old-price">${{ number_format(($new_product_attr_first->regular_price), 2) }}</span>
                                    @endif
                                  <span class="new-price">${{ number_format(($new_product_attr_first->sale_price), 2) }}</span>
                            </span>

                            
                            <div class="ec-pro-option">
                                @if ($new_product_attr_first->color)
                                    
                                <div class="ec-pro-color">
                                    <span class="ec-pro-opt-label">Color</span>
                                    <ul class="ec-opt-swatch ec-change-img">
                                        @foreach ($new_product_attr as $item)
                                            
                                        <li><a href="#" class="ec-opt-clr-img"
                                                data-src="{{ asset('frontend/images/product/'.$item->images) }}"
                                                data-src-hover="{{ asset('frontend/images/product/'.$item->images) }}"
                                                data-tooltip="Orange"><span style="background-color:{{$item->color}};"></span></a></li>
                                        @endforeach
                                    </ul>
                                </div>
                                @endif

                                @if ($new_product_attr_first->size)
                                    ...
                                    <ul class="ec-opt-size">
                                        @foreach ($new_product_attr as $item)
                                            @if ($item->regular_price)
                                                ...
                                                <li class="{{ $loop->first ? 'active' : '' }}"><a href="#" class="ec-opt-sz" data-old="${{$item->regular_price}}"
                                                data-new="${{$item->sale_price}}">{{$item->size}}</a></li>
                                            @else
                                                   
                                                <li class="active"><a href="#" class="ec-opt-sz" data-new="${{$item->sale_price}}">{{$item->size}}</a></li>
                                            @endif
                                        @endforeach
                                    </ul>
                                </div>
                ...
                <div class="col-sm-12 shop-all-btn"><a href="{{ url('category_products') }}">Shop All Collection</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="ec-test-outer">
                    <ul id="ec-testimonial-slider">
                        <li class="ec-test-item">
                            <img src="{{ asset('frontend/images/testimonial/top-quotes.svg') }}"  class="svg_img test_svg top" alt="" />
                            ...
                            <img src="{{ asset('frontend/images/testimonial/bottom-quotes.svg') }}"  class="svg_img test_svg bottom"
                                alt="" />
                        </li>
                        <li class="ec-test-item ">
                            <img src="{{ asset('frontend/images/testimonial/top-quotes.svg') }}"  class="svg_img test_svg top" alt="" />
