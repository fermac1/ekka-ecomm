							...
							<div class="ec-cat-list card card-default mb-24px">
								<div class="card-body">
									<div class="ec-cat-form">
										...
										<form action=" {{ url('admin/add-sub-cat')}} " method="POST" enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    @endif
										<table id="responsive-data-table" class="table">
											...
											<tbody>
                                                ...
                                                <tr>
													<td><img class="cat-thumb" src="{{ asset('frontend/images/category-image/' .$subitem->maincategory->image ) }}" alt="product image"/></td>
													<td> {{ $subitem->name }} </td>
													<td>
														<span class="ec-sub-cat-list">
															<span class="ec-sub-cat-tag">{{ $subitem->maincategory->category_name }}</span>
														</span>
													</td>
													<td> {{ count($subitem->product) }} </td>
													<td>2161</td>
													<td>ACTIVE</td>
													...
													<td>
														<div class="btn-group">
															...
															<div class="dropdown-menu">
																<a class="dropdown-item" href="{{ url('admin/edit_subcategory/'. $subitem->slug ) }}">Edit</a>
																<a class="dropdown-item" href=" {{ url('admin/delete-sub-cat/'.$subitem->id) }} ">Delete</a>
															</div>
														</div>
													</td>
												</tr>  
