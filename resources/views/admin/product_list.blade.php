			...
			<div class="ec-content-wrapper">
				<div class="content">
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						...
						<div>
							<a href="{{ url('admin/add_product') }}" class="btn btn-primary"> Add Porduct</a>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
                                    ...
                                    @endif
										<table id="responsive-data-table" class="table"
											...
											<tbody>
												...
												<tr>
													<td><img class="tbl-thumb" src="{{ asset('frontend/images/product/'. $item->image) }}" alt="Product Image" /></td>
													...
													<td>
														<div class="btn-group mb-1">
															...
															<div class="dropdown-menu">
																<a class="dropdown-item" href="{{ url('admin/edit_product/'. $item->slug ) }}">Edit</a>
																<a class="dropdown-item" href=" {{ url('admin/delete-prod/'.$item->id) }} ">Delete</a>
															</div>
														</div>
													</td>
												</tr>
