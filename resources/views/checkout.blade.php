                            ...
                            <div class="ec-checkout-wrap margin-bottom-30">
                                <div class="ec-checkout-block ec-check-new">
                                    ...
                                    <div class="ec-check-block-content">
                                        ...
                                        <div class="ec-new-btn"><a href=" {{url('register')}} " class="btn btn-primary">Continue</a></div>
                                            ...
                                            <form action="#" method="post">
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    ...
                                                    <input type="text" name="firstname"
                                                        placeholder="Enter your first name" value=" {{Auth::user()->firstname}} " required />
                                                </span>
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    <label>Last Name*</label>
                                                    <input type="text" name="lastname"
                                                        placeholder="Enter your last name" value=" {{Auth::user()->lastname}} " required />
                                                </span>
                                                <span class="ec-bill-wrap">
                                                    <label>Address</label>
                                                    <input type="text" name="address" placeholder="Address Line 1"  value="{{ Auth::user()->address }}"/>
                                                </span>
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    <label>City *</label>
                                                    <span class="ec-bl-select-inner">
                                                        <select name="city" id="ec-select-city"
                                                ...
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    ...
                                                    <span class="ec-bl-select-inner">
                                                        <select name="state" id="ec-select-state"
                                                            class="ec-bill-select">
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="{{ url('single-product/'.$infos['product_name']) }}" class="image">
                                            ...
                                            <div class="ec-pro-content">
                                                <h5 class="ec-pro-title"><a href="{{ url('single-product/'.$infos['slug']) }}">{{$infos['product_name']}}</a></h5>
                                                ...
                                                <span class="ec-price">
                                                    @if ($infos['regular_price'])
                                                    <span class="old-price">${{$infos['regular_price']}}</span>
                                                    @endif
                                                    <span class="new-price">${{$infos['sale_price']}}</span>
                                                </span>
                                                <div class="ec-pro-option">
                                                    ...
                                                    <div class="ec-pro-color">
                                                        ...
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            ...
                                                            <li class="{{ $loop->first ? 'active' : '' }}"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('frontend/images/product/'.$infos['images']) }}"
                                                                data-src-hover="{{ asset('frontend/images/product/'.$infos['images']) }}"
                                                                data-tooltip="Gray"><span
                                                                style="background-color:{{ $infos['color'];}}"></span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    @endif
                                                    ...
                                                    @if ($infos['size'])
                                                        ...
                                                        <div class="ec-pro-size">
                                                            ...
                                                            <ul class="ec-opt-size">
                                                                <li class="{{ $loop->first ? 'active' : '' }}"><a href="#" class="ec-opt-sz"
                                                                    data-old="${{$infos['regular_price']}}" data-new="${{$infos['sale_price']}}">{{$infos['size']}}</a></li>
                                                            </ul>
                                                        </div>
                                                        @else
                                                        ...
                                                        <div class="ec-pro-size">
                                                            <span class="ec-pro-opt-label">Size</span>
                                                            <ul class="ec-opt-size">
                                                                <li class="{{ $loop->first ? 'active' : '' }}"><a href="#" class="ec-opt-sz" data-new="${{$infos['sale_price']}}">{{$infos['size']}}</a></li>
                                                            </ul>
                                                        </div>
                                                        @endif
                                                    @endif
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{ asset('frontend/images/product/'. $new_arrival->image ) }}"
                                        alt="Product" />
                                    <img class="hover-image" src="{{ asset('frontend/images/product/'. $new_arrival->image) }}"
                                        alt="Product" />
                                </a>
                                @if ($new_arrival->discount)
                                    <span class="percentage">{{$new_arrival->discount}}%</span>
                                @endif
                        ...
                        <div class="ec-pro-content">
                            ...
                            <span class="ec-price">
                                @if ($new_arrival->regular_price)
                                    <span class="old-price">${{ $new_arrival->regular_price }}</span>
                                    @endif
                                  <span class="new-price">${{ $new_arrival->sale_price }}</span>
                            </span>
                            <div class="ec-pro-option">
                                <div class="ec-pro-color">
                                    <span class="ec-pro-opt-label">Color</span>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{ asset('frontend/images/product-image/3_1.jpg') }}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{ asset('frontend/images/product-image/3_2.jpg') }}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{ asset('frontend/images/product-image/3_3.jpg') }}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{ asset('frontend/images/product-image/3_4.jpg') }}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{ asset('frontend/images/product-image/3_5.jpg') }}" alt="">
                                </div>
                            </div>
                            ...
                            <div class="quickview-pro-content">
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <div class="ec-quickview-cart ">
                                        <button class="btn btn-primary"><img src="{{ asset('frontend/images/icons/cart.svg') }}"
