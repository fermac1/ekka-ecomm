                      ...
                      <div class="col-md-5 col-sm-12 col-xs-12">
                        ...
                        @endphp
                          ...
                          <div class="qty-product-cover">
                              ...
                              <div class="qty-slide">
                                  <img class="img-responsive" src="{{ asset('frontend/images/product/'. $data->images) }}" alt="Product images">
                              </div>
                              @endforeach
                          ...
                          <div class="quickview-pro-content">
                              ...
                              <div class="ec-quickview-price">
                                   ...
                                   @if ($data->regular_price)
                                    <span class="old-price">${{ $data->regular_price }}</span>
                                    @endif
                                  ...
                                  <div class="ec-pro-variation-inner ec-pro-variation-color">
                                      ...
                                      <div class="ec-pro-color">
                                          <ul class="ec-opt-swatch">
                                              ...
                                              <li><span style="background-color:{{$data->color}};"></span></li>
                                              @endforeach
                                          </ul>
                                      </div>
                                  </div>
                                  ...
                                  <div class="ec-pro-variation-inner ec-pro-variation-size ec-pro-size">
                                      ...
                                      <div class="ec-pro-variation-content">
                                          <ul class="ec-opt-size">
                                              ...
                                              <li class="{{ $loop->first ? 'active' : '' }}"><a href="#" class="ec-opt-sz" >{{$data->size}}</a></li>
                                              @endforeach
                                            </ul>
                                        </div>
                                    </div>
